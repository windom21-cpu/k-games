...
最終更新: 2026-05-03 / 現行バージョン: v1.0.1
...
- v1.0.1 — 候補マスのヒント表示を中央の小さな丸ドットから「マス内側10%余白の角丸四角枠+うっすら白塗り」に変更。クリック可能領域が視覚的に分かりやすくなる(挙動は同じ、CSS のみ変更)
...
| 候補マス枠 | CSS `.cell.hint::after` | inset 10% / 角丸3px / 半透明白塗り+白枠 | 合法手の場所を四角でハイライト(v1.0.1〜) |
